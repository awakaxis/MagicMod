...
public class SpellProjectileModel extends EntityModel<SpellProjectileEntity> {
    ...
    public SpellProjectileModel(ModelPart base) {
        this.base = base;
    }
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild(EntityModelPartNames.CUBE, ModelPartBuilder.create()
                .uv(0,0).cuboid(-8, 16, -8, 16, 16, 16),
                ModelTransform.pivot(0,0,0));
        return TexturedModelData.of(modelData, 64, 64);
    }

    @Override
    public void setAngles(SpellProjectileEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
